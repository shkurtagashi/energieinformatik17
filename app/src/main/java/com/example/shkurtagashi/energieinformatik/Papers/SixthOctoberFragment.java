 ...
 */
public class SixthOctoberFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_sixth_october, container, false);

        CustomAdapter adapter = new CustomAdapter(getContext(), paperTitlesOctober5, paperAuthorsOctober5);

        listView = (ListView) rootView.findViewById(R.id.sixthOctober_list);
