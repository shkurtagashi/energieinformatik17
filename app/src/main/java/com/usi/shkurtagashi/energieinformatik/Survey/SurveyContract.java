...
public class SurveyContract {
    ...
    public static final class SurveyEntry implements BaseColumns {
        ...
        public final static String QUESTION_ENG1 = "questionEng1";
        public final static String QUESTION_ENG2 = "questionEng2";
        ...
        public static final String CHECK_EMAIL = "Checked email- ";
        ...
        public static String[] getColumns(){
            String[] columns = {_ID, TIMESTAMP, PAPER_ID, QUESTION_1, QUESTION_2, QUESTION_3, QUESTION_4, QUESTION_5, QUESTION_6, QUESTION_7, QUESTION_ENG1, QUESTION_ENG2};
